...
public class AddStudentController implements Initializable {
    ...
    @FXML
    void addstddb(ActionEvent event) {
        ...
        if (username.isEmpty() || password.isEmpty() || stdname.isEmpty() || emailid.isEmpty() || dobirth.isEmpty()|| gendr.isEmpty()|| addr.isEmpty()|| mobn.isEmpty()) {
            JOptionPane.showMessageDialog(null,"Enter all fields");

        } else {
            getQuery();
            insert();
            JOptionPane.showMessageDialog(null,"Student Info Added");
    ...
    private void getQuery() {
            ...
            query1 = "INSERT INTO `student`( `username`,`password`,`Name`,`email_id`,`dob`,`gender`,`address`,`mob_no`) VALUES (?,?,?,?,?,?,?,?)";
            query2= "INSERT INTO `loginstd`(`username`,`password`) VALUES(?,?)";
    }
    ...
    private void insert() {
        ...
        try {
            ...
            preparedStatement1.setString(5, dob.getText());
